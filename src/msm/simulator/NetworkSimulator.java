        ...
        if(loadNetwork){
            ...
            try {
                ...
                while(!netOK){
                    ...
                    if(!nets[0].isConnected()){
                        nets[0].reset();
                        System.out.print("\n\tATTEMPT "+attempt+" FAILED - Network is partitioned. ");
                        if(attempt >= 3){
                            throw new NetworkException("Unable to generate a connected network.");
                        } else {
                            System.out.print("RETRY Generation ... ");
                        }
                    } else {
                        netOK = true;
                    }
            ...
            //Calculate and Set Network Diameter and Nodes eccentricity
            nets[0].computeDiameterAndEccentricities();
//            int d = nets[0].calculateDiameter();
//            nets[0].setDiameter(d);
            System.out.println("\t\t\t(Diameter: "+nets[0].getDiameter()+") OK! ");
            System.out.println("\t\t\t(Peripheral Ratio: "+nets[0].calculatePeripheralRatio()+") OK! ");
        ...
        for(int i=1; i < repeatSim+extraRepeatSim; i++){
            ...
            try{
                ...
                while(!netOK){
                    ...
                    n.generateNetwork();
                    if(!n.isConnected()){
                        System.out.println("ATTEMPT "+attempt+" FAILED - Network is partitioned. ");
                        if(attempt >= 3){
                            throw new NetworkException("Unable to generate a connected network.");
                        } else {
                            System.out.print("\tRETRY Generation ... ");
            ...
            System.out.println("\tNetwork Min Degree: "+n.calculateMinDegree());
            System.out.println("\tNetwork Max Degree: "+n.calculateMaxDegree());
            //TODO Calculate network Diameter
            n.computeDiameterAndEccentricities();
//          int d = n.calculateDiameter();
//          n.setDiameter(d);
            System.out.println("\tNetwork Diameter: "+n.getDiameter());
            System.out.println("\tNetwork Peripheral Ratio: "+n.calculatePeripheralRatio());
...
//            Map<Integer, List<BigDecimal>> allMeans_AA = new HashMap<Integer, List<BigDecimal>>(repeatSim+extraRepeatSim);
...
//                List<BigDecimal> tempMeans_AA = new ArrayList<BigDecimal>();
...
//                        System.out.println("00 - CV(RMSE): "+normdev);
//                        for(Node n : comEng.getNetwork().getNodes()){
//                            System.out.print("["+n.getId()+"] = "+n.getApplication().getValue()+", ");
//                        }
//                        System.out.println();
...
//                        tempMeans_AA.add(net.getMeanValue_AA(comEng.getAggFunction(), mc));
...
//                                    System.out.println(time + " - CV(RMSE): "+normdev);
//                                    for(Node n : comEng.getNetwork().getNodes()){
//                                        System.out.print("["+n.getId()+"] = "+n.getApplication().getValue()+", ");
//                                    }
//                                    System.out.println();
...
//                                    tempMeans_AA.add(tempMeans_AA.get(tempMeans_AA.size()-1));
...
//                        allMeans_AA.put(rep, tempMeans_AA);
...
//                System.out.println("\tTotal Message Receive Discard: "+net.getTotalMessageDiscardRcv());
    ...
    */
                           ...
                           case MEAN_A : xValues = calculateMeanValueList(allMeans_A, validRepetitions, maxResultSamples, mc);
                                       break;
//                           case MEAN_AA : xValues = calculateMeanValueList(allMeans_AA, validRepetitions, maxResultSamples, mc);
//                                       break;            
    ...
    */
                           ...
                           case MEAN_A : yValues = calculateMeanValueList(allMeans_A, validRepetitions, maxResultSamples, mc);
                                       break;
//                           case MEAN_AA : yValues = calculateMeanValueList(allMeans_AA, validRepetitions, maxResultSamples, mc);
//                                       break;
    ...
    */
                           ...
                           case MEAN_A : zValues = calculateMeanValueList(allMeans_A, validRepetitions, maxResultSamples, mc);
                                       break;
//                           case MEAN_AA : zValues = calculateMeanValueList(allMeans_AA, validRepetitions, maxResultSamples, mc);
//                                       break;
